...
os.mkdir('C:/users/vince/desktop/{}'.format(BOOK_NAME))
os.mkdir('C:/users/vince/desktop/{}_c'.format(BOOK_NAME))
...
while True:
    ...
    cv2.imwrite('C:/users/vince/desktop/{}/{}.jpg'.format(BOOK_NAME, iter), full_image)

    img1 = full_image[0:1506, 0:1100]
    img2 = full_image[0:1506, 1100:2199]

    out_template = "C:/Users/vince/Desktop/{}_c/{}.jpg"
    cv2.imwrite(out_template.format(BOOK_NAME, iter+adder), img1)
    cv2.imwrite(out_template.format(BOOK_NAME, iter+adder+1), img2)
