...
try:
    for ctr in range(6, len(os.listdir("C:/Users/vince/Desktop/{}_c/".format(BOOK_NAME))) + 1):
        # Settings
        ...
        # Numbers
        find_left = find(cv2.imread("X:/HomeworkBot/core/QuestionExtractor/patterns/number.png", 0), 0.7)
        ...
        for t in range(len(tasks)):
            ff = 'X:/HomeworkBot/core/QuestionExtractor/temp/Task {}.jpg'.format(t)
